...
void TFT_eSPI::init(uint8_t tc)
{
  ...
  // This loads the driver specific initialisation code  <<<<<<<<<<<<<<<<<<<<< ADD NEW DRIVERS TO THE LIST HERE <<<<<<<<<<<<<<<<<<<<<<<
    ...
    #include "utility/ILI9341_Init.h"

#elif defined (ST7735_DRIVER)
    tabcolor = tc;
    #include "utility/ST7735_Init.h"

#elif defined (ILI9163_DRIVER)
    #include "utility/ILI9163_Init.h"

#elif defined (S6D02A1_DRIVER)
    #include "utility/S6D02A1_Init.h"
     
#elif defined (RPI_ILI9486_DRIVER)
    #include "utility/RPI_ILI9486_Init.h"

#elif defined (ILI9486_DRIVER)
    #include "utility/ILI9486_Init.h"

#elif defined (ILI9481_DRIVER)
    #include "utility/ILI9481_Init.h"

#elif defined (ILI9488_DRIVER)
    #include "utility/ILI9488_Init.h"

#elif defined (HX8357D_DRIVER)
    #include "utility/HX8357D_Init.h"

#elif defined (ST7789_DRIVER)
    #include "utility/ST7789_Init.h"
...
#if   defined (ILI9341_DRIVER)
    #include "utility/ILI9341_Rotation.h"

#elif defined (ST7735_DRIVER)
    #include "utility/ST7735_Rotation.h"

#elif defined (ILI9163_DRIVER)
    #include "utility/ILI9163_Rotation.h"

#elif defined (S6D02A1_DRIVER)
    #include "utility/S6D02A1_Rotation.h"

#elif defined (RPI_ILI9486_DRIVER)
    #include "utility/RPI_ILI9486_Rotation.h"

#elif defined (ILI9486_DRIVER)
    #include "utility/ILI9486_Rotation.h"

#elif defined (ILI9481_DRIVER)
    #include "utility/ILI9481_Rotation.h"

#elif defined (ILI9488_DRIVER)
    #include "utility/ILI9488_Rotation.h"

#elif defined (HX8357D_DRIVER)
    #include "utility/HX8357D_Rotation.h"

#elif defined (ST7789_DRIVER)
    #include "utility/ST7789_Rotation.h"
