...
AFDisplay::AFDisplay() : TFT_eSPI() {}

void AFDisplay::begin() {
  TFT_eSPI::begin();
  setRotation(1);
  fillScreen(0);
...
void AFDisplay::sleep() {
  startWrite();
  writecommand(ILI9341_SLPIN); // Software reset
  endWrite();
}

void AFDisplay::setBrightness(uint8_t brightness) {
  //ledcWrite(BLK_PWM_CHANNEL, brightness);
}

void AFDisplay::drawBitmap(int16_t x0, int16_t y0, int16_t w, int16_t h, const uint16_t *data) {
  setSwapBytes(true);
  pushImage((int32_t)x0, (int32_t)y0, (uint32_t)w, (uint32_t)h, data);
}

void AFDisplay::drawBitmap(int16_t x0, int16_t y0, int16_t w, int16_t h, uint16_t *data) {
  setSwapBytes(true);
  pushImage((int32_t)x0, (int32_t)y0, (uint32_t)w, (uint32_t)h, data);
}

void AFDisplay::drawBitmap(int16_t x0, int16_t y0, int16_t w, int16_t h, const uint16_t *data, uint16_t transparent) {
  setSwapBytes(true);
  pushImage((int32_t)x0, (int32_t)y0, (uint32_t)w, (uint32_t)h, data, transparent);
}

void AFDisplay::drawBitmap(int16_t x0, int16_t y0, int16_t w, int16_t h, const uint8_t *data) {
  setSwapBytes(true);
  pushImage((int32_t)x0, (int32_t)y0, (uint32_t)w, (uint32_t)h, (const uint16_t*)data);
}

void AFDisplay::drawBitmap(int16_t x0, int16_t y0, int16_t w, int16_t h, uint8_t *data) {
  setSwapBytes(true);
  pushImage((int32_t)x0, (int32_t)y0, (uint32_t)w, (uint32_t)h, (uint16_t*)data);
}

void AFDisplay::progressBar(int x, int y, int w, int h, uint8_t val) {
...
void AFDisplay::qrcode(const String &string, uint16_t x, uint16_t y, uint8_t width, uint8_t version) {
...
void AFDisplay::drawBmpFile(fs::FS &fs, const char *path, uint16_t x, uint16_t y) {
...
// void AFDisplay::drawBmp(fs::FS &fs, const char *path, uint16_t x, uint16_t y) {
...
void AFDisplay::drawJpg(const uint8_t *jpg_data, size_t jpg_len, uint16_t x,
...
void AFDisplay::drawJpgFile(fs::FS &fs, const char *path, uint16_t x, uint16_t y,
